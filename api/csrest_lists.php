...
if (!defined('CS_REST_CUSTOM_FIELD_TYPE_TEXT')) define('CS_REST_CUSTOM_FIELD_TYPE_TEXT', 'Text');
if (!defined('CS_REST_CUSTOM_FIELD_TYPE_NUMBER')) define('CS_REST_CUSTOM_FIELD_TYPE_NUMBER', 'Number');
if (!defined('CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTONE')) define('CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTONE', 'MultiSelectOne');
if (!defined('CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTMANY')) define('CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTMANY', 'MultiSelectMany');
if (!defined('CS_REST_CUSTOM_FIELD_TYPE_DATE')) define('CS_REST_CUSTOM_FIELD_TYPE_DATE', 'Date');
if (!defined('CS_REST_CUSTOM_FIELD_TYPE_COUNTRY')) define('CS_REST_CUSTOM_FIELD_TYPE_COUNTRY', 'Country');
if (!defined('CS_REST_CUSTOM_FIELD_TYPE_USSTATE')) define('CS_REST_CUSTOM_FIELD_TYPE_USSTATE', 'USState');

if (!defined('CS_REST_LIST_WEBHOOK_SUBSCRIBE')) define('CS_REST_LIST_WEBHOOK_SUBSCRIBE', 'Subscribe');
if (!defined('CS_REST_LIST_WEBHOOK_DEACTIVATE')) define('CS_REST_LIST_WEBHOOK_DEACTIVATE', 'Deactivate');
if (!defined('CS_REST_LIST_WEBHOOK_UPDATE')) define('CS_REST_LIST_WEBHOOK_UPDATE', 'Update');
if (!defined('CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS')) define('CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS', 'AllClientLists');
if (!defined('CS_REST_LIST_UNSUBSCRIBE_SETTING_ONLY_THIS_LIST')) define('CS_REST_LIST_UNSUBSCRIBE_SETTING_ONLY_THIS_LIST', 'OnlyThisList');
